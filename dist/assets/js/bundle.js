  ...
  const fadeUpAnimation = () => {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).on("scroll", function () {
      fadeUpAnimeTrigger.each(function () {
        ...
        let scroll = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).scrollTop();
        let windowHeight = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).height();
        if (scroll > position - windowHeight + 150) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("is-fadeUp");
        }
      });
      fadeDownAnimeTrigger.each(function () {
        ...
        let windowHeight = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).height();
        if (scroll > position - windowHeight + 150) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("is-fadeDown");
        }
      });
      fadeLeftAnimeTrigger.each(function () {
        ...
        let windowHeight = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).height();
        if (scroll > position - windowHeight + 150) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("is-fadeLeft");
        }
      });
      fadeRightAnimeTrigger.each(function () {
        ...
        let windowHeight = jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).height();
        if (scroll > position - windowHeight + 150) {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass("is-fadeRight");
        }
      });
    });
  };
